...
def setMeterValues(values, block):
    ...
    block.add_string    (values.get("c_manufacturer"  ,"12345678901234567890123456789012"))
    block.add_string    (values.get("c_model"         ,"12345678901234567890123456789012"))
    block.add_string    (values.get("c_option"        ,"1234567890123456"))
    block.add_string    (values.get("c_version"       ,"1234567890123456"))
    block.add_string    (values.get("c_serialnumber"  ,"12345678901234567890123456789012"))
...
def t_update(ctx, stop, module, device, refresh):
    ...
    while not stop.is_set():
        try:
            ...
            block_40000.add_string    (values.get("c_manufacturer"  ,"12345678901234567890123456789012"))
            block_40000.add_string    (values.get("c_model"         ,"12345678901234567890123456789012"))
            block_40000.add_string    (                              "NOT_IMPLEMENTED.")
            block_40000.add_string    (values.get("c_version"       ,"1234567890123456"))
            block_40000.add_string    (values.get("c_serialnumber"  ,"12345678901234567890123456789012"))
